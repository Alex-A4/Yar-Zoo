...
import 'package:flutter_yar_zoo/views/about_root.dart';
import 'package:flutter_yar_zoo/views/manual_view.dart';
import 'package:flutter_yar_zoo/views/news_root.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: Icon(Icons.assignment), title: Text('Новости')),
          BottomNavigationBarItem(icon: Icon(Icons.people), title: Text('О нас')),
          BottomNavigationBarItem(icon: Icon(Icons.import_contacts), title: Text('Справочник')),
        ],
